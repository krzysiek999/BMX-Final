...
public class PartPanel extends javax.swing.JPanel {
   ...
   // ScrollPaneLayout layout = new ScrollPaneLayout();
    ...
    public PartPanel(ShopResearcher researcher, MainFrame frame, PartFrame thisFrame) 
    {
        ...
        this.number = researcher.getNumber();
        ...
        backButton = new JButton(languageChoice.getString("back"));
        basketButton = new JButton(languageChoice.getString("basket"));
        addBasketButton = new JButton(languageChoice.getString("addBasket"));
    ...
    {
        String[][] arrayInformation = researcher.getInformations();
        
        ShopPanel shopPanel = new ShopPanel();
        
        shopPanel.setLabel(arrayInformation, this.number);
    ...
    class ShopPanel extends JPanel
    {
        ...
        public void setLabel(String[][] array, int number)
        {
            
            for(int i = 0; i < number; i++)
        {
            tableModel.addRow(new String[]{"" + (i+1), array[i][0], array[i][1]});
        }
            this.add(table);
